  ...
  return (
    <section className="py-12 md:py-24 max-w-7xl mx-auto px-6" id="contact">
      <div className="glass-card border-black/5 rounded-lg overflow-hidden grid md:grid-cols-2">
        <div className="p-6 md:p-20 space-y-12">
        ...
        <div className="bg-black/5 p-6 md:p-20 flex flex-col justify-center border-t md:border-t-0 md:border-l border-black/5 relative">
          <AnimatePresence>
            {isSuccess ? (
              <motion.div 
